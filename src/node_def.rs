...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n3tensorflow/tensorflow/core/framework/node_def.proto\x12\ntensorflow\
    \x1a*tensorflow/core/framework/attr_value.proto\"\xde\x01\n\x07NodeDef\
    \x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04name\x12\x0e\n\x02op\x18\x02\
    \x20\x01(\tR\x02op\x12\x14\n\x05input\x18\x03\x20\x03(\tR\x05input\x12\
    \x16\n\x06device\x18\x04\x20\x01(\tR\x06device\x121\n\x04attr\x18\x05\
    \x20\x03(\x0b2\x1d.tensorflow.NodeDef.AttrEntryR\x04attr\x1aN\n\tAttrEnt\
    ry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12+\n\x05value\x18\x02\
    \x20\x01(\x0b2\x15.tensorflow.AttrValueR\x05value:\x028\x01B*\n\x18org.t\
    ensorflow.frameworkB\tNodeProtoP\x01\xf8\x01\x01J\xdb\x15\n\x06\x12\x04\
    ...
    \0\x02\0\x12\x03\x0e\x02\x12\x1a\xb0\x01\x20The\x20name\x20given\x20to\
    \x20this\x20operator.\x20Used\x20for\x20naming\x20inputs,\n\x20logging,\
    \x20visualization,\x20etc.\x20\x20Unique\x20within\x20a\x20single\x20Gra\
    phDef.\n\x20Must\x20match\x20the\x20regexp\x20\"[A-Za-z0-9.][A-Za-z0-9_.\
    ...
    \0\x02\x01\x12\x03\x12\x02\x10\x1a\x84\x01\x20The\x20operation\x20name.\
    \x20\x20There\x20may\x20be\x20custom\x20parameters\x20in\x20attrs.\n\x20\
    Op\x20names\x20starting\x20with\x20an\x20underscore\x20are\x20reserved\
    \x20for\x20internal\x20use.\n\n\r\n\x05\x04\0\x02\x01\x04\x12\x04\x12\
    ...
    \x1b\n\x9e\x06\n\x04\x04\0\x02\x03\x12\x03/\x02\x14\x1a\x90\x06\x20A\x20\
    ...
    \x20\x20\x20\x20\x20\x20|\x20(\x20(\"gpu\"\x20|\x20\"cpu\")\x20\":\"\x20\
    ([1-9][0-9]*\x20|\x20\"*\")\x20)\n\n\x20Valid\x20values\x20for\x20this\
    \x20string\x20include:\n\x20*\x20\"/job:worker/replica:0/task:1/device:G\
    PU:3\"\x20\x20(full\x20specification)\n\x20*\x20\"/job:worker/device:GPU\
    :3\"\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20(partial\x20specification)\n\x20*\x20\"\"\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20(no\x20specification\
    )\n\n\x20If\x20the\x20constraints\x20do\x20not\x20resolve\x20to\x20a\x20\
    single\x20device\x20(or\x20if\x20this\n\x20field\x20is\x20empty\x20or\
    \x20not\x20present),\x20the\x20runtime\x20will\x20attempt\x20to\n\x20cho\
    ose\x20a\x20device\x20automatically.\n\n\r\n\x05\x04\0\x02\x03\x04\x12\
    \x04/\x02\x19\x1c\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03/\x02\x08\n\x0c\n\
    \x05\x04\0\x02\x03\x01\x12\x03/\t\x0f\n\x0c\n\x05\x04\0\x02\x03\x03\x12\
    \x03/\x12\x13\n\x94\x05\n\x04\x04\0\x02\x04\x12\x03=\x02\"\x1a\x86\x05\
    \x20Operation-specific\x20graph-construction-time\x20configuration.\n\
    \x20Note\x20that\x20this\x20should\x20include\x20all\x20attrs\x20defined\
    \x20in\x20the\n\x20corresponding\x20OpDef,\x20including\x20those\x20with\
    \x20a\x20value\x20matching\n\x20the\x20default\x20--\x20this\x20allows\
    \x20the\x20default\x20to\x20change\x20and\x20makes\n\x20NodeDefs\x20easi\
    er\x20to\x20interpret\x20on\x20their\x20own.\x20\x20However,\x20if\n\x20\
    an\x20attr\x20with\x20a\x20default\x20is\x20not\x20specified\x20in\x20th\
    is\x20list,\x20the\n\x20default\x20will\x20be\x20used.\n\x20The\x20\"nam\
    es\"\x20(keys)\x20must\x20match\x20the\x20regexp\x20\"[a-z][a-z0-9_]+\"\
    \x20(and\n\x20one\x20of\x20the\x20names\x20from\x20the\x20corresponding\
    \x20OpDef's\x20attr\x20field).\n\x20The\x20values\x20must\x20have\x20a\
    \x20type\x20matching\x20the\x20corresponding\x20OpDef\n\x20attr's\x20typ\
    e\x20field.\n\x20TODO(josh11b):\x20Add\x20some\x20examples\x20here\x20sh\
    owing\x20best\x20practices.\n\n\r\n\x05\x04\0\x02\x04\x04\x12\x04=\x02/\
    \x14\n\x0c\n\x05\x04\0\x02\x04\x06\x12\x03=\x02\x18\n\x0c\n\x05\x04\0\
    \x02\x04\x01\x12\x03=\x19\x1d\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03=\x20\
    !b\x06proto3\
";
