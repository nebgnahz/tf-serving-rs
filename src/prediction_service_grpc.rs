...
impl PredictionServiceClient {
    ...
    pub fn classify_async_opt(&self, req: super::classification::ClassificationRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::classification::ClassificationResponse> {
        self.client.unary_call_async(&METHOD_PREDICTION_SERVICE_CLASSIFY, req, opt)
    }

    pub fn classify_async(&self, req: super::classification::ClassificationRequest) -> ::grpcio::ClientUnaryReceiver<super::classification::ClassificationResponse> {
    ...
    pub fn regress_async_opt(&self, req: super::regression::RegressionRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::regression::RegressionResponse> {
        self.client.unary_call_async(&METHOD_PREDICTION_SERVICE_REGRESS, req, opt)
    }

    pub fn regress_async(&self, req: super::regression::RegressionRequest) -> ::grpcio::ClientUnaryReceiver<super::regression::RegressionResponse> {
    ...
    pub fn predict_async_opt(&self, req: super::predict::PredictRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::predict::PredictResponse> {
        self.client.unary_call_async(&METHOD_PREDICTION_SERVICE_PREDICT, req, opt)
    }

    pub fn predict_async(&self, req: super::predict::PredictRequest) -> ::grpcio::ClientUnaryReceiver<super::predict::PredictResponse> {
    ...
    pub fn multi_inference_async_opt(&self, req: super::inference::MultiInferenceRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::inference::MultiInferenceResponse> {
        self.client.unary_call_async(&METHOD_PREDICTION_SERVICE_MULTI_INFERENCE, req, opt)
    }

    pub fn multi_inference_async(&self, req: super::inference::MultiInferenceRequest) -> ::grpcio::ClientUnaryReceiver<super::inference::MultiInferenceResponse> {
    ...
    pub fn get_model_metadata_async_opt(&self, req: super::get_model_metadata::GetModelMetadataRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::get_model_metadata::GetModelMetadataResponse> {
        self.client.unary_call_async(&METHOD_PREDICTION_SERVICE_GET_MODEL_METADATA, req, opt)
    }

    pub fn get_model_metadata_async(&self, req: super::get_model_metadata::GetModelMetadataRequest) -> ::grpcio::ClientUnaryReceiver<super::get_model_metadata::GetModelMetadataResponse> {
...
pub trait PredictionService {
    fn classify(&self, ctx: ::grpcio::RpcContext, req: super::classification::ClassificationRequest, sink: ::grpcio::UnarySink<super::classification::ClassificationResponse>);
    fn regress(&self, ctx: ::grpcio::RpcContext, req: super::regression::RegressionRequest, sink: ::grpcio::UnarySink<super::regression::RegressionResponse>);
    fn predict(&self, ctx: ::grpcio::RpcContext, req: super::predict::PredictRequest, sink: ::grpcio::UnarySink<super::predict::PredictResponse>);
    fn multi_inference(&self, ctx: ::grpcio::RpcContext, req: super::inference::MultiInferenceRequest, sink: ::grpcio::UnarySink<super::inference::MultiInferenceResponse>);
    fn get_model_metadata(&self, ctx: ::grpcio::RpcContext, req: super::get_model_metadata::GetModelMetadataRequest, sink: ::grpcio::UnarySink<super::get_model_metadata::GetModelMetadataResponse>);
}
